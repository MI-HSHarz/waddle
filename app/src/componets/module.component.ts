                    ...
                    <div class="row">
                        <div class="col s12 m6 teal white-text card module half">
                            ...
                            <div class="card-reveal">
                              ...
                              <ul class="navigation-list">
                                ...
                                <li><a href="#!" class="white-text">Materialien</a></li>
                              </ul>
                            </div>
                        </div>
                        <div class="col s12 m6 teal darken-2 white-text card module half">
                            <div class="card-image waves-effect waves-block waves-light">
                             ...
                             <div class="card-content">
                                <span class="card-title activator">Berufskolleg Weißenfels</span>
                                <a href="#!" class="white-text"><i class="material-icons right">info</i></a>
                    ...
                    <div class="row">
                        <div class="col s12 m6 teal lighten-2 white-text card module half">
                            <div class="card-image waves-effect waves-block waves-light">
                             ...
                             <div class="card-content">
                                <span class="card-title activator">Berufskolleg Bad Godesberg</span>
                                <a href="#!" class="white-text"><i class="material-icons right">info</i></a>
                        ...
                        <div class="col s12 m6 teal darken-3 white-text card module half">
                           <div class="card-image waves-effect waves-block waves-light">
                             ...
                             <div class="card-content">
                                <span class="card-title activator">Berufskolleg Montabaur</span>
                                <a href="#!" class="white-text"><i class="material-icons right">info</i></a>
